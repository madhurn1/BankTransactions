...
public class MoneyMarket extends Savings{
    ...
    /**
     ...
     @param newLoyalty the newloyalty value.
     */
     ...
     */
    public void setWithdrawal (int x) {withdrawal = x;}
    /**
    ...
    /**
     ...
     @return the monthly fee if your balance is less than 2000 and no fee if balance greater than or equal to 2000
     */
    @Override
